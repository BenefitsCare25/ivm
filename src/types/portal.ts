...
export const FWA_RULE_TYPES = new Set([
  ...
  "SUBSIDY_DEDUCTION", "NON_CLAIMABLE_PAYMENT", "POSSIBLE_DUPLICATE", "SPECIALIST_REVIEW",
]);

export const FWA_PRIORITY: Record<string, number> = {
  TAMPERING: 3, UNREADABLE_DOCUMENT: 2, WRONG_CLAIM_TYPE: 2, CLAIMANT_MATCH: 2,
  SUBSIDY_DEDUCTION: 2, NON_CLAIMABLE_PAYMENT: 2, POSSIBLE_DUPLICATE: 2,
  DOC_TYPE_MATCH: 1, BUSINESS_RULE: 1, REQUIRED_DOCUMENT: 1, SPECIALIST_REVIEW: 1,
...
export const FWA_LABELS: Record<string, string> = {
  ...
  SUBSIDY_DEDUCTION: "Subsidy Deduction",
  NON_CLAIMABLE_PAYMENT: "Non-Claimable Payment",
